...
#what if you get random spells by calling on the spells endpoint, populating an array of the randomly fetched spells and then use the .each method on that array?